...
// Fork: public (upstream: internal) — composeApp HomeScreen + tests consume these cross-module.
fun WatchProgressEntry.resolvedProgressKey(): String =
    progressKey
...
fun ProgressSyncRecord.resolvedProgressKey(): String =
...
fun ProgressDeltaEvent.resolvedProgressKey(): String =
    progressKey.takeIf(String::isNotBlank) ?: run {
        buildWatchProgressKey(
            contentId = contentId,
            seasonNumber = season,
...
fun Collection<WatchProgressEntry>.newestByProgressKey(): Map<String, WatchProgressEntry> {
 ...
 */
fun Collection<WatchProgressEntry>.resolveIdentityForUpsert(
