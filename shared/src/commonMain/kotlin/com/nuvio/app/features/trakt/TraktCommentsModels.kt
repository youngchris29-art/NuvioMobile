...
enum class TraktCommentsType(val apiValue: String) {
    MOVIE("movie"),
    SHOW("show"),
}
...
@Serializable
data class TraktCommentsSearchResultDto(
...
@Serializable
data class TraktCommentsSearchItemDto(
    @SerialName("ids") val ids: TraktCommentsIdsDto? = null,
)

@Serializable
data class TraktCommentsIdsDto(
