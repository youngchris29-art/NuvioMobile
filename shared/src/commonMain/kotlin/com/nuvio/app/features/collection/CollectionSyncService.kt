...
object CollectionSyncService {
    ...
    suspend fun pullFromServer(profileId: Int) {
        ...
        runCatching {
            ...
            if (ActiveProfileProvider.activeProfileId != profileId) return@runCatching
    ...
    fun triggerPush() {
        ...
        pushJob = scope.launch {
            val profileId = ActiveProfileProvider.activeProfileId
            delay(500)
            if (ActiveProfileProvider.activeProfileId != profileId) return@launch
