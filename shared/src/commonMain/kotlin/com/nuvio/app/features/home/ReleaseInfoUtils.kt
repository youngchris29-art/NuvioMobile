...
// Fork: public (upstream: internal) — composeApp ReleaseInfoUtilsTest consumes cross-module.
...
// Fork: public (upstream: internal) — composeApp ReleaseInfoUtilsTest consumes cross-module.
fun HomeCatalogSection.filterReleasedItems(
    todayIsoDate: String,
    nowEpochMs: Long = EpisodeReleaseDatePlatform.nowEpochMs(),
): HomeCatalogSection {
...
// Fork: public (upstream: internal) — composeApp ReleaseInfoUtilsTest consumes cross-module.
fun List<MetaPreview>.filterReleasedItems(
    todayIsoDate: String,
    nowEpochMs: Long = EpisodeReleaseDatePlatform.nowEpochMs(),
