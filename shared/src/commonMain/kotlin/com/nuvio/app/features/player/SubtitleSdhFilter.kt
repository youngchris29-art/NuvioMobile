...
// Public (upstream: internal) because the fork hosts this in shared/ while
// composeApp's PlayerEngine.android.kt consumes it across the module boundary.
object SubtitleSdhFilter {
