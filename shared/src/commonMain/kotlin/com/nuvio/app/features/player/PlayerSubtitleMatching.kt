...
object SubtitleLanguageMatching {
    // Fork: public (upstream: internal) — composeApp's PlayerSubtitleUtils reads the tag lists.
    val BRAZILIAN_TAGS = listOf(
        "pt-br", "pt_br", "pob", "brazilian", "brazil", "brasil", "brasileiro", " br", "(br)",
    )
    val EUROPEAN_PT_TAGS = listOf(
        "pt-pt", "pt_pt", "iberian", "european", "portugal", "europeu", " eu", "(eu)",
    )
    val LATINO_TAGS = listOf(
