...
data class ParentalGuideLabels(
    val nudity: String,
    val violence: String,
...
object ParentalGuideRepository {
...
fun resolveParentalGuideSeverity(category: ImdbApiParentsGuideCategory?): String? {
...
fun extractParentalGuideImdbId(value: String?): String? =
    value
        ?.let { imdbIdPattern.find(it)?.value }
        ?.takeIf { it.startsWith("tt") }

fun extractParentalGuideTmdbId(value: String?): Int? {
